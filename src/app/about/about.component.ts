...
export class AboutComponent {
  public alertMessage = 'This alert needs your attention, but it\'s not super important.';

  public sampleModal: any;
  ...
  public statesComplex: any[] = [
    ...
    {id: 2, name: 'Alaska', region: 'West'}, {id: 3, name: 'Arizona', region: 'West'},
  ...
  public constructor() {
    this.dataSource = Observable
      .create((observer: any) => {
        observer.next(this.asyncSelected); // Runs on every search
      })
